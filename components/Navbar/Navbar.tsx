        ...
        <nav className="navbar py-4">
            <div className="container is-fluid">
                ...
                <div className="navbar-menu">
                    <div className="navbar-start"><a className="navbar-item" href="/about">About</a><a className="navbar-item"
                        href="/contact-us">Contact Us</a><a className="navbar-item" href="/services">Services</a></div>
